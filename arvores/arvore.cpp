...
int main()
{
    ...
    (search(root, 5) != NULL) ? cout << "encontrado" << endl : cout << "nao encontrado" << endl;
    (search(root, 13) != NULL) ? cout << "encontrado" << endl : cout << "nao encontrado" << endl;

    (search(root, 10) != NULL) ? cout << "encontrado" << endl : cout << "nao encontrado" << endl;
    remove(root, 10);
    (search(root, 10) != NULL) ? cout << "encontrado" << endl : cout << "nao encontrado" << endl;
